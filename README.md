...
**This is a fork of [jonasmerlin/react-native-markdown-display](https://github.com/jonasmerlin/react-native-markdown-display), which is a fork of [iamacup/react-native-markdown-display](https://github.com/iamacup/react-native-markdown-display) that increases the depended upon versions of react to 17 and react-native to v0.68, making it compatible with Expo SDK 45. This fork improves compatability by using Babel to compile the JSX to plain JS.**
